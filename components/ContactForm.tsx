    ...
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-16">
        ...
        <div className="mt-4 flex items-center justify-center gap-2 text-blue-400/60 font-orbitron text-[9px] tracking-widest">
          <Mail size={12} />
          <a href="mailto:confluxdotai@gmail.com" className="hover:text-blue-400 transition-colors uppercase">confluxdotai@gmail.com</a>
        </div>
      </div>
        ...
        {status === 'success' ? (
          ...
          >
            ...
            <div className="p-4 bg-white/5 border border-white/10 rounded-lg inline-block">
              ...
              <a href="mailto:confluxdotai@gmail.com" className="text-blue-400 font-orbitron text-xs hover:underline">confluxdotai@gmail.com</a>
            </div>
            <br />
            <button
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  type="email"
                  required
                  placeholder="resistance@confluxai.in"
                  className="w-full bg-white/5 border border-white/10 p-4 text-white text-sm focus:border-blue-500/50 outline-none transition-all rounded-sm"
